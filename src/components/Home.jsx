...
const Home = () => {
 ...
 <input
    ...
    placeholder="search place"
        ...
        />
 <svg xmlns="http://www.w3.org/2000/svg" className='absolute w-6 h-6 text-black top-2 right-[68%]' fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
